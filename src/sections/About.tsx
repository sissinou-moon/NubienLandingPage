...
export default function About() {
    return (
        <div className='relative z-10 flex flex-col items-center justify-start h-full bg-black pb-10'>
            ...
            <RevealText text='Built on creativity, collaboration, and top excellence, SYNC is a dynamic team of industry experts committed to achieving exceptional great results...' className='text-[35px] text-white font-[500] text-center max-w-250 mt-5'>
            </RevealText>
