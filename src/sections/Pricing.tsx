...
export default function PricingScroll() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mx-auto py-20 bg-black h-full z-20 relative px-15">
            {/* Left: Sticky Video */}
            <div className="sticky top-20 h-[80vh] rounded-2xl overflow-hidden shadow-xl mb-20">
                <video
